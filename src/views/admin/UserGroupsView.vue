  ...
  <section>
    <header class="title-row">
      ...
      <n-space>
        ...
        <n-button type="primary" @click="showCreate = true">新建用户组</n-button>
      </n-space>
    </header>
    ...
    <n-modal v-model:show="showCreate" preset="card" title="新建用户组" style="max-width: 620px">
      <n-form label-placement="top">
        <n-grid :cols="24" :x-gap="12">
          ...
          <n-form-item-gi :span="12" label="默认组">
          ...
          <n-form-item-gi :span="12" label="每日次数上限">
            <n-input-number v-model:value="form.daily_limit" :min="0" :precision="0" style="width: 100%" />
          </n-form-item-gi>
          <n-form-item-gi :span="12" label="并发上限">
            <n-input-number v-model:value="form.concurrency_limit" :min="0" :precision="0" style="width: 100%" />
          </n-form-item-gi>
        </n-grid>
      </n-form>
      <template #footer>
